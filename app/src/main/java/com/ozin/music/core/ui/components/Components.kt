...
/**
 * A rounded, elevated container used to group related settings rows/controls
 * so a screen reads as distinct sections instead of one flat wall of
 * controls stacked directly on the background.
 */
@Composable
fun SettingsCard(
